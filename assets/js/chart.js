(function() {
    ...
    var color = self.color = d3.scale.ordinal()
        .domain(["President", "First lady", "Second lady" , "Supreme Court nominee", "Adviser to the president"])
    ...
    d3.json("final.json", function(error, network) {
        ...
        personDot.append("image")
            .attr("xlink:href", "merge_from_ofoct.jpg")
            .attr("x", function(d, i) {
